...
setInterval(() => {
  http.get(`http://g1music7.glitch.me/`); //تعديل مهم حط اسم المشروع
}, 280000);
...
const GUILDID = '456967240127086593'; //  تعديل مهم ايدي السيرفر  
const CHANNELID = '456986166546268160'; // تعديل مهم ايدي الروم الصوتي
...
//تغير الحالة
const developers = ["450400539172143105","","",""] ///تعديل مهم حط هنا ايدي اللي بدك يتحكمو بالحالة
...
const youtube = new YouTube("AIzaSyCk45eVq_4X3d-4oVHXzm0Jp4MBpQ_NLn4"); 
